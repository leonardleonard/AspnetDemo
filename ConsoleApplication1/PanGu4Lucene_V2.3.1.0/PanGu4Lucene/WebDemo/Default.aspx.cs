...
public partial class _Default : System.Web.UI.Page 
{
    ...
    private void ShowTable(string text)
    {
        ...
        sw.Start();
        List<TNews> newsList = Index.Search(indexDir, text, pageSize, pageNo, out recCount);
        sw.Stop();
        LabelDuration.Text = "用时：" + sw.ElapsedMilliseconds.ToString() + "毫秒";
